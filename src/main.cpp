    ...
    for (const char *p = text; *p != '\0'; p++) {
        ...
        if (c >= 'a' && c <= 'z') {
            ...
            switch (c) {
                ...
                case '=': enqueue_key(KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_MINUS); break;
                ...
                case '\\': enqueue_key(kNoModifier, HID_KEY_KANJI1); break;
                case ']': enqueue_key(kNoModifier, HID_KEY_EUROPE_1); break;
                case '^': enqueue_key(kNoModifier, HID_KEY_EQUAL); break;
                case '_': enqueue_key(KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_KANJI1); break;
                ...
                case '|': enqueue_key(KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_KANJI3); break;
                case '}': enqueue_key(KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_EUROPE_1); break;
